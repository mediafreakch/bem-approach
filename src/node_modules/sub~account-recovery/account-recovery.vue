  ...
  module.exports = {
    ...
    methods: {
      ...
      formRequestSmsTryToSend: function() {
        ...
        api.requestSmsCode(this);
      },
      formVerifyTryToSend: function() {
        api.verifySmsCode(this);
      },
      formPassportTryToSend: function() {
        api.sendPassportImage(this);
      },
