...
<template>
  ...
  <form>
    ...
    <div v-if="isForm1Valid && phonePart !== '' && authyId === ''">
      <p>We found a mobile phone number related to your account:</p>
      <p>+41 XX XXX {{phonePart}}</p>
      <p>We will send you a code by SMS to help you create a new
        email-address.</p>
    </div>
    ...
    <div v-if="isLandline && isForm1Valid" >
      ...
      <div style="position: relative;">
        ...
        <label for="idUpload" class="btn btn-link" style="position:absolute; right: 0; top: 21px;">Datei auswählen</label>
      </div>
    </div>
...
<script>
  ...
  module.exports = {
    ...
    computed: {
      ...
      wording: function() {
        return {
          button: this.phonePart !== '' && this.isForm1Valid && !this.emailChangeConfirmed ? (this.authyId === '' ? 'Send SMS' : 'Confirm') : 'UpdateAccount'
        };
      }
    },
    methods: {
