<template>
  <form>
    ...
    <button type="submit" class="btn btn-primary pull-right" v-if="states.edit" @click.prevent="sendEmail">E-Mail-Addresse aktualisieren
    </button>
    <button v-if="states.edit" class="btn btn-secondary" v-link="{ path: '/de-ch/user-profile' }">
      Abbrechen
    </button>
  </form>
</template>
