...
<template>
  ...
  <form>
    ...
    <button class="btn btn-success btn-block" v-if="states.sent" disabled="disabled">E-Mail gesendet</button>
    <button type="submit" class="btn btn-primary btn-block" v-if="states.edit" @click.prevent="sendEmail">E-Mail-Addresse aktualisieren
    </button>
    <button v-if="states.edit" class="btn btn-secondary btn-block" v-link="{ path: '/user-profile' }">
      Abbrechen
    </button>
  </form>
...
<script>
  ...
  module.exports = {
    ...
    methods: {
      ...
      valueChange: function(newValue, isValid) {
        this.value = newValue;
