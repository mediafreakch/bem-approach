...
module.exports = new Vuex.Store({
  ...
  state: {
    ...
    errorMessage: 'Ein Fehler is aufgetreten. Leider stehen zur Zeit keine weiteren Informationen zur Verfügung.',
    states: {
      isLandline: false,
      isMobile: false,
      isError: false,
  ...
  mutations: {
    ...
    SET_CONFIRMATION_EMAIL_SENT: function(state) {
      state.states.isConfirmationEmailSent = true;
    },
